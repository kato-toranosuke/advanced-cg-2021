...
void Scene01Checker2D::ReloadShaders()
{
  ...
  glVertexAttribPointer(s_pShader->getAttributeLocation("vertexPosition"), 2,
                        GL_FLOAT, GL_FALSE, 0, (const void *)0); // vertices

  glEnableVertexAttribArray(s_pShader->getAttributeLocation("inTexCoord"));
  glVertexAttribPointer(
      s_pShader->getAttributeLocation("inTexCoord"), 2, GL_FLOAT, GL_FALSE, 0,
